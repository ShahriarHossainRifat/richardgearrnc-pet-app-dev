...
mixin _$PostUser {
 ...
 String get id;@JsonKey(name: 'fullName') String get fullName; String? get image;@JsonKey(name: 'userName') String get userName;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'fullName') String fullName, String? image,@JsonKey(name: 'userName') String userName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'fullName')  String fullName,  String? image, @JsonKey(name: 'userName')  String userName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostUser() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'fullName')  String fullName,  String? image, @JsonKey(name: 'userName')  String userName)  $default,) {final _that = this;
switch (_that) {
case _PostUser():
return $default(_that.id,_that.fullName,_that.image,_that.userName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'fullName')  String fullName,  String? image, @JsonKey(name: 'userName')  String userName)?  $default,) {final _that = this;
switch (_that) {
case _PostUser() when $default != null:
return $default(_that.id,_that.fullName,_that.image,_that.userName);case _:
  return null;
...
class _PostUser implements PostUser {
  const _PostUser({required this.id, @JsonKey(name: 'fullName') required this.fullName, this.image, @JsonKey(name: 'userName') required this.userName});
