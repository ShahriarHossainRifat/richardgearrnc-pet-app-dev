                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      crossAxisSpacing: 12,
                      mainAxisSpacing: 16,
                      childAspectRatio: 0.62, // taller cards - prevents overflow
                    ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return PetProductCard(
                        imageUrl: product.images.isNotEmpty ? product.images.first! : 'https://via.placeholder.com/300x160?text=No+Image',
                        title: product.name,
