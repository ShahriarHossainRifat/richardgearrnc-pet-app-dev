...
PetSitterModel petSitterModelFromJson(String str) =>
    PetSitterModel.fromJson(json.decode(str) as Map<String, dynamic>);

String petSitterModelToJson(PetSitterModel data) => json.encode(data.toJson());
...
class User {
  ...
  final String email;
  final String? image; // ← made nullable (your sample has valid URLs, but better safe)
