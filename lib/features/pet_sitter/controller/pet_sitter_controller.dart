...
class PetSitterController extends GetxController {
  ...
  // You can store token here after login (or load from storage)
  // For demo I'm hard-coding it — in real app NEVER do this!
  final String _token =
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        try {
          ...
          if (model.success == true) {
            ...
            Get.snackbar('Success', 'Loaded ${petSitters.length} sitters',
